...
namespace MLMWebsite.Migrations
{
    ...
    [Migration("20190319172120_aprroveduser")]
    partial class aprroveduser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MLMWebsite.Models.ApprovedUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MLMWebsite.Models.DummyAdminAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MLMWebsite.Models.AddressProof", b =>
                {
                    b.HasOne("MLMWebsite.Data.ApplicationUser", "ApplicationUser")
                        .WithOne("AddressProofs")
                        .HasForeignKey("MLMWebsite.Models.AddressProof", "UserId");
                });
            ...
            modelBuilder.Entity("MLMWebsite.Models.BarCode", b =>
                {
                    b.HasOne("MLMWebsite.Data.ApplicationUser", "ApplicationUser")
                        .WithOne("BarCodes")
                        .HasForeignKey("MLMWebsite.Models.BarCode", "UserId");
                });
            ...
            modelBuilder.Entity("MLMWebsite.Models.UserAssets", b =>
                {
                    b.HasOne("MLMWebsite.Data.ApplicationUser", "ApplicationUser")
                        .WithOne("UserAssets")
                        .HasForeignKey("MLMWebsite.Models.UserAssets", "UserId");
                });
